...
#
lbl = tk.Label(root, text="Railway Track Fault Detection System", font=('times', 30,' bold '), height=1, width=60,bg="black",fg="white")
lbl.place(x=0, y=20)
...
#    global fn
    ...
    if fn!="":
        ...
        model = load_model('railway_model.h5')
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D:\23-24 data\23ci1609\Railway Track Fault Detection\railway track fault detection', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
