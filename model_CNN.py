...
path1 = 'E:/2023-24 Topic List/Data (ML topics)/railway track fault detection/railway track fault detection/dataset/test/0'    #path of folder of images    
path2 = 'E:/2023-24 Topic List/Data (ML topics)/railway track fault detection/railway track fault detection/dataset/test/0'  #path of folder to save images    
