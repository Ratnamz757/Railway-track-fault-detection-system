...
print(value)
# Create a Label widget for Fullname and change its text color
label_fullname = tk.Label(window, textvariable=Fullname, fg="red")  # Change "red" to your desired color
